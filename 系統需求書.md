...
1. **全台 1,559 陸地網格覆蓋**：以 15 台 GitHub Actions 獨立工作機（擁有 15 個不同微軟雲端公網 IP），平行掃描全台 1,559 個 3km 經緯度基準點，探索全台所有上線店家。
...
flowchart TD
    subgraph STAGE_1 ["階段 1: 點位調度 (Coordinator)"]
        A[1,559 個全台陸地掃描點<br/>taiwan_scan_points_3km.csv] --> B[分片調度器<br/>taiwan_crawler_coordinator.py]
